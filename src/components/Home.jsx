...
const Home = () => {
  //Text
  const firstTexts = ["Graphic Designer", "Communication", "Video Grapher", "Photographer", "Video Editor"];
  const secondTexts = [
    "Branding",
    "Marketing",
    ...
    <>
        ...
        <div>
          <div id="wrap">
            ...
            >
              ...
              <span className="title">Unduh CV</span>
      ...
      <div className="main-containe" data-bs-spy="scroll">
        ...
        <section className="section-one overflow-hidden" id="home">
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              ...
              <p className="best fade_down show">
                Lulusan D4 Manajemen Produksi Media, Fakultas llmu Komunikasi Universitas Padjadjaran. Tertarik dengan <span>branding</span> dan marketing.</p>
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              <div className="worked-box">
                <p className="worked-more">Jakarta, Indonesia</p>
                <div className="client-img-main position-relative">
                  ...
                  <img
                    ...
                    alt="clients-img4"
                  />
                  <p className="worked-more worked-more2"> 2 Years</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="Marquee-main overflow-hidden">
          <h3 className="fade_up">Experience in Leading Companies</h3>
