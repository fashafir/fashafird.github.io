        ...
        <div className="portfolios-group-main">
          <div>
            ...
            <div className="second-row-portfolio youtube zoom_in">
              <div>
                ...
                >
                  ...
                  <div className="overlay">
                    ...
                    />
                    <p className="overlay-text">Life at IDSurvey</p>
                  </div>
                </div>
                <YouTubeModal
              ...
              <p className="Corporate">Life at IDSurvey</p>
              <p className="Corporate-sub">social media content</p>
            </div>
          </div>
          <div>
            <div>
              ...
              >
                ...
                <div className="overlay">
                  <img src={ContentSvg} alt="vimeo-svg" className="vimeo-icon" />
                  <p className="overlay-text">Corporate E-Newsletter</p>
                </div>
              </div>
              <VimeoModal
                isOpen={isModalOpen}
            ...
            <p className="Corporate zoom_in">Corporate E-Newsletter</p>
            <p className="Corporate-sub zoom_in">BOOK, INDESIGN</p>
            <div>
              <div
